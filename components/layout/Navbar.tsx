    ...
    <>
      ...
      <nav className={`cbs-nav${scrolled ? " scrolled" : ""}`} role="navigation" aria-label="Main navigation">
        <Link href="/" className="nav-logo" aria-label="Callus Brand Solutions home">
          ...
          {/* Swapped text mark for image component with safe layout overrides */}
          <div 
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          <a
            href="https://calendly.com/cbscallusbrandsolutions/free-brand-auditing"
            target="_blank"
      ...
      {portalOpen && (
        <div className="portal-overlay" onClick={(e) => e.target === e.currentTarget && setPortalOpen(false)}>
          <div className="portal-box">
            ...
            {/* Also swapped the logo box inside the login box container here */}
            <div 
              className="nav-logo-mark" 
              style={{ 
                position: "relative", 
